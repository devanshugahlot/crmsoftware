...
import { FaFacebook, FaInstagram, FaShareAlt, FaTelegram } from "react-icons/fa";
...
const FileContent = () => {
  ...
  <Button onClick={onFileUpload} >Submit</Button>
          ...
          <Input type="file" accept="image/*" onChange={onFileChange} />
            ...
            <div>
            <p>Tan No.*</p>
              <Input placeholder="Enter enter your Tan No" />
            </div>
            <div>
          <p>Upload Tan Photo</p>
          <Input type="file" accept="image/*" onChange={onFileChange} />
            </div>
        ...
        <div>
          ...
          <div>
            ...
            <div>
              <p>Facebook</p>
              <Input placeholder="Enter your Facebook Account username " />
            </div>
            <div>
              <p>Twitter</p>
              <Input placeholder="Enter Twitter account username" />
            </div>
            <div>
              <p>Whatsapp</p>
            ...
            <div>
            <p>Linkdin</p>
              <Input placeholder="Enter Linkdin account username" />
            </div>
        ...
        <div className="Referral-container">
          ...
          <div className="Referral-share"><CustomizedDialogs/></div>
        </div>
      </div>
    </Fragment>
  );
