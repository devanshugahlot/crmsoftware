              ...
              <Table id="myTable">
                <thead>
                  <tr>
                    ...
                    <th onClick={sortByConnection}>No of Connection.<FaSort style={{color:"#BABABA"}} /></th>
                    <th onClick={sortByApproval}>Approval <FaSort style={{color:"#BABABA"}} /></th>
                  </tr>
                </thead>
                <tbody>
