export const MENUITEMS = [
  {
    ...
    Items: [
...

      {
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/widgets/general`, title: "Daily Task ", type: "link" },
          { path: `${process.env.PUBLIC_URL}/widgets/chart`, title: "Linkedin Account", type: "link" },
        ],
      },
    ],
  },

  {
    ...
    Items: [
      ...
      //   active: false,
      //   children: [
      //     // { path: , type: "link", title: "Project-List" },
      //     { path: `${process.env.PUBLIC_URL}/app/project/new-project`, type: "link", title: "Create New" },
      //   ],
      // },
      { path: `${ process.env.PUBLIC_URL }/app/file-manager`, icon: "file", title: "Profile", type: "link" },
      { path: `${process.env.PUBLIC_URL}/app/project/project-list`, icon: "email", title: "Document", type: "link" },
      { path: `${process.env.PUBLIC_URL}/app/ecommerce/product`, icon: "email", title: "Project Details", type: "link" },
      { path: `${process.env.PUBLIC_URL}/app/ecommerce/product-page`, icon: "email", title: "Webinar", type: "link" },
      { path: `${ process.env.PUBLIC_URL }/app/ecommerce/pricing`, icon: "file", title: "Leads", type: "link" },
      { path: `${process.env.PUBLIC_URL}/app/ecommerce/invoice`, icon: "file", title: "Follow UP", type: "link" },
      { path: `${process.env.PUBLIC_URL}/app/chat-app/chats`,icon: "chat", type: "link", title: "Project converted"},
      ...
      // },
      {
        ...
        children: [
          ...
          { path: `${process.env.PUBLIC_URL}/app/chat-app/chat-video-app`, type: "link", title: "All referral" },
        ],
      },
      {
        title: "Income",
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/app/users/profile`, type: "link", title: "transcation" },
          { path: `${process.env.PUBLIC_URL}/app/users/edit`, type: "link", title: "My Income" },
          { path: `${process.env.PUBLIC_URL}/app/users/cards`, type: "link", title: "My referral Income"},
        ],
      },
